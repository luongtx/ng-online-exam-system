...
@Component({
  selector: 'app-exam-question-edit',
  templateUrl: './exam-question-edit.component.html',
  styleUrls: ['./exam-question-edit.component.css']
})
export class ExamQuestionEditComponent implements OnInit, OnChanges {
